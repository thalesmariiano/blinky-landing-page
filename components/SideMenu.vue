<template>
    <div class="w-full h-screen fixed top-0 right-0 bg-[#083027] md:hidden p-5">
        <div class="w-full flex justify-end">
            <button @click="$emit('close')">
                <IconsClose widht="44" height="44" fill="#fff" />
            </button>
        </div>
        <nav>
            <ul class="space-y-5 mt-5">
                ...
                <li class="text-center">
                    <a href="https://pay.blinkybr.com/register" class="blinky-button-shine w-72 hoverAnimation mx-auto flex gap-3 justify-center items-center text-sm font-poppins font-semibold text-black bg-gradient-to-r from-blinkyBlue to-blinkyGreen px-4 py-1.5 rounded-lg">
                        Cadastre-se
