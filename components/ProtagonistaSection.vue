     ...
     <section @mousemove="parallax" class="relative -skew-y-[4deg] bg-[#070707] overflow-hidden px-2">
        ...
        <div class="relative mx-auto w-full max-w-lg flex justify-center items-center skew-y-[4deg] py-48">
            ...
            <div class="flex gap-10 flex-col">
                ...
                <a href="https://pay.blinkybr.com/register" class="hoverAnimation w-full flex gap-3 justify-center items-center font-poppins font-semibold md:text-lg text-black bg-gradient-to-r from-blinkyBlue to-blinkyGreen px-4 py-1.5 rounded-lg">
                        Cadastre-se
