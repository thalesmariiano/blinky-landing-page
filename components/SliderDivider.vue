<template>
    <div class="absolute -top-12 left-0 w-full h-[4.5rem] flex gap-10 md:gap-20 justify-center items-center bg-gradient-to-r from-blinkyBlue to-blinkyGreen overflow-hidden">
