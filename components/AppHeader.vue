        ...
        <header class="w-full max-w-4xl flex justify-between items-center">
            ...
            <nav class="hidden md:block">
                <ul class="flex gap-10 items-center">
                    ...
                    <li>
                        <a href="https://pay.blinkybr.com/register" class="hoverAnimation flex gap-3 items-center text-sm font-poppins font-semibold text-black bg-gradient-to-r from-blinkyBlue to-blinkyGreen px-4 py-1.5 rounded-lg">
                            Cadastre-se
